...
{
    {
        nameof(TutorialBurgurNames.데리버거), new string[] { "햄버거빵", "불고기", "햄버거빵" }
    },
    {
        nameof(Level1BurgurNames.새우버거), new string[] { "먹물빵", "양상추", "새우", "먹물빵" }
    },
     {
          nameof(Level1BurgurNames.토토버거), new string[] { "샌드위치빵", "토마토", "토마토","샌드위치빵" }
    },
    {
          nameof(Level1BurgurNames.토마토패티버거), new string[] { "샌드위치빵", "불고기", "토마토", "불고기" }
    },
    {
           nameof(Level1BurgurNames.더블치즈버거), new string[] { "햄버거빵", "치즈", "치즈", "햄버거빵" }
    },
    {
          nameof(Level1BurgurNames.베이컨버거), new string[] { "먹물빵", "불고기", "베이컨", "먹물빵" }
    }, {
          nameof(Level1BurgurNames.머쉬룸버거), new string[] { "햄버거빵", "불고기", "버섯","먹물빵"  }
    },
    {
          nameof(Level1BurgurNames.촉촉한버거), new string[] { "햄버거빵", "불고기", "양파", "햄버거빵" }
    }, {
          nameof(Level1BurgurNames.불고기버거), new string[] { "샌드위치빵", "양상추", "불고기", "햄버거빵" }
    },
    {
          nameof(Level2BurgurNames.치즈불고기버거), new string[] { "햄버거빵", "불고기", "치즈", "양상추","햄버거빵" }
    },
     {
         nameof(Level2BurgurNames.샌드위치햄버거), new string[] { "샌드위치빵", "불고기", "치킨", "치즈", "샌드위치빵" }
    },
    {
          nameof(Level2BurgurNames.치킨버거), new string[] { "샌드위치빵", "치킨", "치즈", "토마토", "샌드위치빵" }
    },
        {
           nameof(Level2BurgurNames.트리플고기버거), new string[] { "먹물빵", "치킨", "불고기", "베이컨", "샌드위치빵" }
    },
          {
      nameof(Level2BurgurNames.먹물버거), new string[] { "먹물빵", "새우", "불고기", "양상추", "먹물빵" }
    },
              {
           nameof(Level2BurgurNames.양파버거), new string[] { "양상추", "양파", "새우", "양파", "먹물빵" }
    },
                 {
           nameof(Level2BurgurNames.육즙가득버거), new string[] { "불고기", "양파", "양상추", "토마토", "불고기" }
    },           {
         nameof(Level2BurgurNames.버섯많이버거), new string[] { "샌드위치빵", "버섯", "불고기", "버섯", "햄버거빵" }
    },
                   {
           nameof(Level3BurgurNames.살찌는버거), new string[] { "샌드위치빵", "치즈", "치킨", "양상추", "불고기","햄버거빵" }
    },
         {
   nameof(Level3BurgurNames.치즈토마토버거), new string[] { "햄버거빵", "양상추", "토마토", "치즈", "불고기","햄버거빵" }
},
{
  nameof(Level3BurgurNames.샌드위치치즈버거), new string[] { "햄버거빵", "불고기", "치즈", "토마토", "양상추", "샌드위치빵" }
},
{
  nameof(Level3BurgurNames.다이어트버거), new string[] { "양상추", "샌드위치빵", "치즈", "토마토", "치즈", "양상추" }
},
{
  nameof(Level3BurgurNames.고칼로리버거), new string[] { "먹물빵", "치즈", "베이컨", "새우", "불고기", "먹물빵" }
},
{
  nameof(Level3BurgurNames.더블새우버거), new string[] { "샌드위치빵", "새우", "베이컨", "양상추", "새우", "햄버거빵" }
},
{
    nameof(Level3BurgurNames.직화버섯불고기버거), new string[] { "먹물빵", "버섯", "불고기", "치즈", "양파", "햄버거빵" }
},
{
   nameof(Level3BurgurNames.치즈새우버거), new string[] { "샌드위치빵", "치즈", "양파", "베이컨", "새우", "햄버거빵" }
},
{
  nameof(Level4BurgurNames.기네스버거), new string[] { "먹물빵", "불고기", "치즈", "치즈", "불고기", "양파", "먹물빵" }
},
{
   nameof(Level4BurgurNames.수분가득버거), new string[] { "햄버거빵", "베이컨", "양파", "양상추", "새우", "버섯", "햄버거빵" }
},
{
   nameof(Level4BurgurNames.통큰버거), new string[] { "불고기", "양상추", "양파", "베이컨", "새우", "버섯", "불고기", "양상추" }
},
{
  nameof(Level4BurgurNames.비주얼버거), new string[] { "햄버거빵", "양상추", "치즈", "베이컨", "불고기", "양파", "샌드위치빵" }
},
{
   nameof(Level4BurgurNames.폭탄칼로리버거), new string[] { "먹물빵", "양상추", "치즈", "불고기", "치즈", "불고기", "먹물빵" }
},
{
   nameof(Level4BurgurNames.일편단심버거), new string[] { "양상추", "베이컨", "양파", "새우", "양파", "불고기", "양상추" }
},
{
  nameof(Level4BurgurNames.기력보충버거), new string[] { "샌드위치빵", "버섯", "베이컨", "양파", "새우", "버섯", "샌드위치빵" }
},
{
 nameof(Level4BurgurNames.빵많이버거), new string[] { "먹물빵", "치킨", "베이컨", "양파", "샌드위치빵", "불고기", "햄버거빵" }
},
